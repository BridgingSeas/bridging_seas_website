...
export default function Home() {
  return (
    <div className="bg-background text-foreground">
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-[1440px] px-6 py-10 sm:px-10 sm:py-14 lg:px-16">
          ...
          <div className="mt-6 flex justify-center">
            <Link
              href="/get-involved"
              className="rounded-2xl bg-primary px-12 py-3 text-center text-base transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(44,62,64,0.18)] sm:min-w-[280px] sm:text-lg"
            >
              Get Involved
            </Link>
          </div>
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-[1440px] px-6 py-2 sm:px-10 sm:py-3 lg:px-16">
